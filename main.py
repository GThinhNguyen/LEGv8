...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def show_instruction(self):
        ...
        text.setHtml(
            ...
            "<ul>"
            "<li><b>Open File:</b> Mở tệp mã lệnh LEGv8 từ máy tính.</li>"
            "<li><b>Close File:</b> Đóng tệp mã lệnh hiện tại.</li>"
            "<li><b>Save File:</b> Lưu mã lệnh vào tệp.</li>"
            "<li><b>Run All:</b> Thực thi toàn bộ chương trình còn lại.</li>"
            "<li><b>Skip Step:</b> Thực hiện từng bước mô phỏng (mỗi lần nhấn sẽ chạy 1 block trên sơ đồ).</li>"
            "<li><b>Skip Line:</b> Thực hiện từng dòng lệnh (mỗi lần nhấn sẽ chạy hết 1 dòng code).</li>"
            "<li><b>Skip Breakpoint:</b> Chạy đến dòng có breakpoint tiếp theo. Đặt breakpoint bằng cách nhấn vào vị trí trước số dòng.</li>"
            "<li><b>Undo Step:</b> Quay lại bước mô phỏng trước đó.</li>"
            "<li><b>Undo Line:</b> Quay lại dòng lệnh trước đó.</li>"
            "<li><b>Animate:</b> Chạy mô phỏng với hiệu ứng hoạt hình (nhấn lại để dừng), thanh tốc độ dùng để điều chỉnh tốc độ animation, có thể sử dụng các nút skip trong quá trình animation.</li>"
            "<li><b>Reset:</b> Đặt lại RAM, thanh ghi và trạng thái về mặc định.</li>"
            "<li><b>Help:</b> Xem hướng dẫn sử dụng phần mềm.</li>"
            "</ul>"
            "<hr>"
            ...
            "- Thanh ghi 64 bit có dấu, nhập giá trị từ -9223372036854775808 đến 9223372036854775807. Kết quả phép tính có thể bị tràn số.<br>"
            "- Chỉ chỉnh sửa DoubleWordValue ở dòng đầu mỗi word.<br>"
            "- LDUR và STUR chỉ hỗ trợ địa chỉ chia hết cho 8 từ 0 đến 504 (tương ứng với 64 dòng RAM).<br>"
            "- Mỗi dòng code phải viết liền nhau, không được để dòng trống. Địa chỉ các dòng code bắt đầu từ 0 và cách nhau 4 byte.<br>"
            "- Các lệnh nhảy (B, CBZ, B.cond) trường #imm là số dòng cần nhảy, chiều dương hướng xuống.<br>"
            "- Có thể dùng dấu <code>//</code> để chú thích trong code, nhưng mỗi dòng vẫn phải có lệnh hợp lệ.</span>"
            "<hr>"
